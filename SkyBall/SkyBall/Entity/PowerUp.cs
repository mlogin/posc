...
namespace SkyBall.Entity
{
    public class PowerUp : DrawableGameObject
    {
        ...
        public void ReInitialize()
        {
            ...
            PowerUpType = (Power.PowerType)types.GetValue(Tools.Rnd.Next(types.Length - 1));
            InitialPosition = new Vector2(Tools.Rnd.Next(GameConfig.WIDTH), (GameConfig.HEIGHT - Height) / 2);
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (Displayed)
            {
                ...
                {
                    string playerId = "player " + (ball.Speed.Y > 0 ? "1" : "2");
